...
import { FaCheckCircle, FaStar, FaQuoteLeft, FaTimesCircle, FaFacebook, FaTwitter, FaInstagram, FaEnvelope } from "react-icons/fa";
            ...
            <div className="col-md-4 mb-4" data-aos="zoom-in" data-aos-delay="300">
              <div className="card h-100 border-0 card-hover">
                <div className="card-body text-center p-4">
                  <div className="mb-4">
                    <img
                      src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face&auto=format"
                      alt="Emily Davis"
                      className="rounded-circle"
                      style={{ width: "80px", height: "80px" }}
                    />
              ...
              <div className="card h-100 shadow-sm border-0">
                <div className="card-body text-center py-4 px-3">
                  ...
                  <ul className="list-unstyled mt-4 mb-4 text-start px-4">
                    <li>
                      <FaCheckCircle className="me-2 text-success" /> Up to 10 tasks
                    </li>
                    <li>
                      <FaCheckCircle className="me-2 text-success" /> Basic features
                    </li>
                    <li>
                      <FaCheckCircle className="me-2 text-success" /> Email support
                    </li>
                    <li>
                      <FaTimesCircle className="me-2 text-danger" /> AI suggestions
                    </li>
                  </ul>
            ...
            <div className="col-md-4 mb-4" data-aos="flip-up" data-aos-delay="200">
              <div className="card h-100 shadow border" style={{ borderColor: "#fd7e14" }}>
                ...
                <div className="card-body text-center py-4 px-3">
                  ...
                  <h2 style={{ color: "#fd7e14" }}>
                    $9<small className="text-muted">/month</small>
                  </h2>
                  <ul className="list-unstyled mt-4 mb-4 text-start px-4">
